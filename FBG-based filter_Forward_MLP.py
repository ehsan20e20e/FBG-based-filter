...
# Input consist of 5 geometric parameter of FBG and the wavelength
# Output is the transmission value at the wavelength (300 point for through port and 800 point for drop port)
Model = Sequential()
