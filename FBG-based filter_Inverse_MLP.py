...
# Input consist of 1600 point of transmission spectrum (300 point for through port and 800 point for drop port)
# Output consist of 5 geometric parameter of FBG
Model = Sequential()
Model.add(Dense(60, input_dim=300))
